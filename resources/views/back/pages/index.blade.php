                ...
                @foreach ($pages as $page)
                    <tr id="page_{{$page->id}}">
                      <td class="text-center" style="width=1%">
                        ...
                        <td>
                          <img src="{{asset($page->image)}}" width="150" height="100">
                        </td>
                        <td>{{$page->title}}</td>
                        <td>
                          <input class="switch" page-id="{{$page->id}}" type="checkbox" data-on="Aktif" data-off="Pasif" data-onstyle="success" data-offstyle="light" @if($page->status==1) checked @endif data-toggle="toggle data-width="100"  ">
                        </td>
                        <td>
                          <a target="_blank" href="{{route('page', $page->slug)}}" title="Görüntüle" class="btn btn-sm btn-secondary"><i class="fa fa-eye"></i> </a>
